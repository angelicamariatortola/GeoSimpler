                          ...
                          fix.mean = T, trend, SigmaB = NULL)
{
  ...
  {     ## Cenario univariado 
    ...
    {# else (p > 1) --> multivariado: mesmo modelo de covariância para todas as respostas
      ...
      ## Log sum of cholesky diagonal elements (soma a diagonal da matrix Cholesky univariada e multiplica por p)
